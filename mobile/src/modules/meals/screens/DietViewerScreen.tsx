...
const styles = StyleSheet.create({
  ...
  statsCard: { flexDirection: 'row', flexWrap: 'wrap',     backgroundColor: colors.surface, borderRadius: rounded.lg, padding: 14, gap: 0,     borderWidth: StyleSheet.hairlineWidth,     borderColor: colors.border, },
  ...
  doseCard: {     backgroundColor: colors.surface, borderRadius: rounded.lg, padding: 16, gap: 12,     borderWidth: StyleSheet.hairlineWidth,     borderColor: colors.border, },
  doseItem: { flexDirection: 'row', gap: 10, alignItems: 'flex-start' },
  doseText: { flex: 1, fontSize: 13, color: colors.onSurface, lineHeight: 19 },
  dayCard: {     backgroundColor: colors.surface, borderRadius: rounded.lg, overflow: 'hidden',     borderWidth: StyleSheet.hairlineWidth,     borderColor: colors.border, },
  dayHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 12, backgroundColor: colors.primaryContainer },
  dayHeadVeg: { backgroundColor: `${colors.success}20` },
  dayName: { fontSize: 15, fontWeight: '700', color: colors.onSurface },
  dayTag: { fontSize: 10, fontWeight: '600', color: colors.primary, backgroundColor: colors.primaryContainer, paddingHorizontal: 8, paddingVertical: 3, borderRadius: rounded.full },
  dayTagVeg: { color: colors.success, backgroundColor: `${colors.success}15` },
  mealRow: { flexDirection: 'row', borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.border },
  ...
  notesCard: {     backgroundColor: colors.surface, borderRadius: rounded.lg, padding: 16, gap: 8,     borderWidth: StyleSheet.hairlineWidth,     borderColor: colors.border, },
