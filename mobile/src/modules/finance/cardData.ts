...
export const CARD_DEFINITIONS: CardDefinition[] = [
  ...
  },
  {
    ...
    pointValue: 1,
    categories: [
      { name: 'All Spends', rate: 1.5, comment: '1.5% cashback on all eligible spends' },
    ],
    caps: [],
    exclusions: ['Cash advance', 'EMI', 'Wallet load'],
    fuelSurchargeWaiver: 'Standard 1%',
    forexMarkup: 3.5,
    welcomeBonus: 'Lifetime Free (₹0 annual fee)',
    notes: 'No-frills LTF card with flat 1.5% cashback. Good backup card.',
  },
  {
    id: 'cred-indusind',
    name: 'CRED IndusInd',
  ...
  },
  {
    ...
    pointValue: 1,
    categories: [
      { name: 'Online Spends', rate: 2, comment: '2% cashback on online spends' },
      { name: 'Offline Spends', rate: 1, comment: '1% cashback on offline spends' },
    ],
    caps: [
      { category: 'Online', maxAmount: 200, period: 'monthly' },
      { category: 'Offline', maxAmount: 200, period: 'monthly' },
    ],
    exclusions: ['Fuel', 'Wallet load', 'Rent'],
    fuelSurchargeWaiver: 'None',
    forexMarkup: 3.5,
    welcomeBonus: 'Lifetime free',
    notes: 'South Indian Bank Pazapp card. Limited cashback caps. Good for small online spends.',
  },
  {
    id: 'load-card',
    name: 'Load Card',
