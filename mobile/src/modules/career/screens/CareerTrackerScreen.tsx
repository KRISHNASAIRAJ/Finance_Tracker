...
const styles = StyleSheet.create({
  ...
  emptyGraph: { fontSize: 13, color: colors.onSurfaceVariant, textAlign: 'center', paddingVertical: 20 },
  ...
  connector: { width: 2, flex: 1, backgroundColor: 'rgba(255,255,255,0.1)', marginVertical: 2 },
  eventCard: {
    flex: 1,
    backgroundColor: colors.surfaceContainer,
  ...
  eventDate: { fontSize: 11, color: colors.onSurfaceVariant },
  eventNotes: { fontSize: 12, color: colors.onSurfaceVariant, lineHeight: 16 },
});
